...
class ShowerStartSingleParticle(AnaBase):
    ...
    def process(self, data):
        ...
        if (len(data['truth_particles']) > 0):
            ...
            p_de_leg, p_dx_leg, p_l_leg = cluster_dedx_legacy(true_shower.points, true_shower.depositions, startpoint)
            ...
            p_de_inc_1, p_dx_inc_1, spread_1, p_fit_1, num_clust_1, start_clust_size_1, true_p_axis_1, true_clust_sizes_1  = cluster_dedx_DBScan_PCA(true_shower.points, true_shower.depositions, startpoint, eps=1.0, dedx_dist=self.radius, detailed=True)
            ...
            out_dict['true_de_leg'] = p_de_leg
            out_dict['true_dx_leg'] = p_dx_leg
            out_dict['true_l_leg'] = p_l_leg
            ...
            out_dict['true_p_start_clust_size'] = start_clust_size
            out_dict['true_PCA_de_inc_1'] = p_de_inc_1
            out_dict['true_PCA_dx_inc_1'] = p_dx_inc_1
            out_dict['true_p_spread_1'] = spread_1
            out_dict['true_p_fit_1'] = p_fit_1
            out_dict['true_p_num_clust_1'] = num_clust_1
            out_dict['true_p_start_clust_size_1'] = start_clust_size_1
            ...
            sed_de_leg, sed_dx_leg, sed_l_leg = cluster_dedx_legacy(sed_points, sed_vals, startpoint)
            sed_de_inc, sed_dx_inc, sed_spread, sed_fit, sed_num_clust, sed_start_clust_size, sed_p_axis, sed_clust_sizes = cluster_dedx_DBScan_PCA(sed_points, sed_vals, startpoint, dedx_dist=self.radius, detailed=True)
            sed_de_inc_1, sed_dx_inc_1, sed_spread_1, sed_fit_1, sed_num_clust_1, sed_start_clust_size_1, sed_p_axis_1, sed_clust_sizes_1 = cluster_dedx_DBScan_PCA(sed_points, sed_vals, startpoint, eps = 1.0, dedx_dist=self.radius, detailed=True)

            out_dict['sed_de_leg'] = sed_de_leg
            out_dict['sed_dx_leg'] = sed_dx_leg
            out_dict['sed_l_leg'] = sed_l_leg
            
            out_dict['sed_true_PCA_de_inc'] = sed_de_inc
            out_dict['sed_true_PCA_dx_inc'] = sed_dx_inc
            out_dict['sed_true_p_spread'] = sed_spread
            out_dict['sed_true_p_fit'] = sed_fit
            out_dict['sed_true_p_num_clust'] = sed_num_clust

            out_dict['sed_true_PCA_de_inc_1'] = sed_de_inc_1
            out_dict['sed_true_PCA_dx_inc_1'] = sed_dx_inc_1
            out_dict['sed_true_p_spread_1'] = sed_spread_1
            out_dict['sed_true_p_fit_1'] = sed_fit_1
            out_dict['sed_true_p_num_clust_1'] = sed_num_clust_1
            ...
            reco_p_de_inc_1, reco_p_dx_inc_1, reco_spread_1, reco_p_fit_1, reco_num_clust_1, reco_start_clust_size_1, reco_p_axis_1, reco_clust_sizes_1  = cluster_dedx_DBScan_PCA(reco_shower.points, reco_shower.depositions, startpoint, eps=1.0, dedx_dist=self.radius, detailed=True)
            ...
            out_dict['reco_p_start_clust_size'] = reco_start_clust_size
            
            out_dict['reco_PCA_de_inc_1'] = reco_p_de_inc
            out_dict['reco_PCA_dx_inc_1'] = reco_p_dx_inc
            out_dict['reco_p_spread_1'] = reco_spread
            out_dict['reco_p_fit_1'] = reco_p_fit
            out_dict['reco_p_num_clust_1'] = reco_num_clust
            out_dict['reco_p_start_clust_size_1'] = reco_start_clust_size
